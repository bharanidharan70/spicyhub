...
if (isset($_POST['submit'])) {
    ...
    try {
        ...
        $mail->isHTML(true);
        $mail->Subject = 'New Contact Message - Spicy Hub';

        $mail->Body = "
  <div style='font-family: Arial, sans-serif; line-height:1.6; color:#333;'>
    
    <h2 style='color:#8b0000;'>📞 New Contact Message Received</h2>

    <p>Hello Team,</p>

    <p>
  A new <strong>contact message</strong> has been received
  through the <strong>Spicy Hub Restaurant</strong> website.  
  Please find the message details below 👇
   </p>
    <hr>
 ...
 ";
        ...
        $mail->send();
        echo "<h2>✅ Message Successful! We will contact you soon.</h2>";
    } catch (Exception $e) {
        echo "<h2>❌ failed.</h2>";
